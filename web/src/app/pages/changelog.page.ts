...
const CHANGELOG: ChangelogGroup[] = [
  ...
  {
    date: '2026-08-05',
    items: ['MAC is now the primary key; position is a renameable plain number (1–10 digits) or legacy XX-XXX'],
  },
  {
    date: '2026-07-14 to 2026-07-16',
    items: [
  ...
  { date: '2026-05-14', items: ['Initial commit'] },
];
  ...
  template: `
    ...
    <ion-content class="ion-padding">
      <div class="page-narrow">
        @for (group of changelog; track group.date) {
          <h3>{{ group.date }}</h3>
          <ul>
