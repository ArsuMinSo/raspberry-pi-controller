...
- [ ] **Web service** — web page for everyone via nginx on tv.omnika.com (LAN, plain HTTP for now); TUI stays as local break-glass tool;
  ...
  - [ ] Later: HTTPS in nginx via Let's Encrypt for tv.omnika.com (DNS-01)
